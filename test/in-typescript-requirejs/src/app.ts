...
app.get('/emulate-key-in-browser.js', (_req, res) => res.sendFile(path.resolve(__dirname, '../../../dist/bundles/emulate-key-in-browser.amd.js')));
app.get('/tslib.js', (_req, res) => res.sendFile(require.resolve('tslib')));
app.get('/emulate-tab.js', (_req, res) => res.sendFile(require.resolve('emulate-tab/dist/bundles/emulate-tab.amd.js')));
...
app.get('/favicon.ico',
  (_req, res) => res.sendFile(path.join(__dirname, '../dist/favicon.ico')),
);
