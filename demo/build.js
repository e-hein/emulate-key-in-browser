...
function buildAngularSample() {
  ...
  const src = path.join(srcProjectDir, 'dist/emulate-key-in-browser-in-angular-material');
  ...
  try {
    ...
    shelljs.exec('ng build --prod --base-href ./ --output-path dist/emulate-key-in-browser-in-angular-material', inAngular);
    fs.accessSync(src, W_OK);
  }
